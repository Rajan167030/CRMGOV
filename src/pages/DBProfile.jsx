  ...
  return (
    <div style={{ padding: p }}>
      <div style={{ maxWidth: 620, margin: "0 auto" }}>
        <div style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 14, padding: isMobile ? "20px" : "28px", marginBottom: 16 }}>
          <div style={{ display: "flex", gap: isMobile ? 14 : 18, alignItems: isMobile ? "center" : "flex-start", marginBottom: 24, flexDirection: isMobile ? "column" : "row", textAlign: isMobile ? "center" : "left" }}>
            ...
            <div>
              <h2 style={{ color: T.text, fontSize: isMobile ? 18 : 20, fontWeight: 900, margin: "0 0 4px", fontFamily: "'Syne',sans-serif" }}>Admin Central</h2>
              <div style={{ color: T.sub, fontSize: 13, marginBottom: 10 }}>admin@pscrm.gov.in · +91 98765 00000</div>
              <div style={{ display: "flex", gap: 7, justifyContent: isMobile ? "center" : "flex-start", flexWrap: "wrap" }}>
        ...
        <div style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 14, padding: isMobile ? "18px" : "22px" }}>
